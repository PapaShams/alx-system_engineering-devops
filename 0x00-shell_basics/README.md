...
File 18-commas writes a command that lists all the files and directories of the current directory, separated by commas (,).a script that prints the absolute path name of the current working directory.